...
![img](Linux 写时复制机制原理.assets/bVcRr08)
...
![img](Linux 写时复制机制原理.assets/bVcRr09)
...
![img](Linux 写时复制机制原理.assets/bVcRr1a)
...
本篇文章主要介绍了 Linux `写时复制` 的原理，`写时复制` 是 Linux 创建子进程高效的关键所在，而且还能节省对物理内存使用。



## 参考文章

1. [linux-kernel - Linux 写时复制机制原理 - 个人文章 - SegmentFault 思否](https://segmentfault.com/a/1190000039869422)